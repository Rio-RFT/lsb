...
static void BumpDownloadCount(const std::shared_ptr<baseDownload>& download, const std::string& key)
{
	...
	RegGetValueW(HKEY_CURRENT_USER, L"Software\\LSB\\DownloadCount", ToWide(key).c_str(), RRF_RT_REG_DWORD, NULL, &count, &countLen);

	++count;
	download->count = count;

	RegSetKeyValueW(HKEY_CURRENT_USER, L"Software\\LSB\\DownloadCount", ToWide(key).c_str(), REG_DWORD, &count, sizeof(count));
}
...
static std::map<int, std::map<std::string, GameCacheEntry>> g_entriesToLoadPerBuild = {
	...
	{
	"update/update.rpf",
	"3895f37ae89747f7ad321d5708e9f7d294d01f42",
	"https://content.cfx.re/mirrors/patches_fivem/3717/update.rpf",
	1933795328,
	{
	...
	{
	"update/update2.rpf",
	"c3c28df9b49dc88bf5dac7ba983e0f7366fd87bd",
	"https://content.cfx.re/mirrors/patches_fivem/3717/update2.rpf",
	494108672,
	{
	...
	{
	"update/update.rpf",
	"49ed7a6c3d035bcf764942dd58597211448941fd",
	"https://content.cfx.re/mirrors/patches_fivem/3570/update.rpf",
	1452832768,
	{
	...
	{
	"update/update2.rpf",
	"28095c30975ffaead56ff72dfb6418d19eef38dc",
	"https://content.cfx.re/mirrors/patches_fivem/3570/update2.rpf",
	457410560,
	{
	...
	{
	"update/update.rpf",
	"f6cdcdec5e3e993a31f45acc96b638283c474f53",
	"https://content.cfx.re/mirrors/patches_fivem/3407/update.rpf",
	1432735744,
	{
	...
	{
	"update/update2.rpf",
	"b379e1752718ea1d799194b8aa70b58b28cd8c5f",
	"https://content.cfx.re/mirrors/patches_fivem/3407/update2.rpf",
	440010752,
	{
	...
	{
	"update/update.rpf",
	"3633a58585791b30281cec14f90f5ac1e2bfdc57",
	"https://content.cfx.re/mirrors/patches_fivem/3323/update.rpf",
	1423288320,
	{
	...
	{
	"update/update2.rpf",
	"f2007adb84a8fc9e4481d58faf88ffca3af754c5",
	"https://content.cfx.re/mirrors/patches_fivem/3323/update2.rpf",
	416063488,
	{
	...
	{
	"update/update.rpf",
	"abf3a580ddfc4cb372b5a4ce48ed7b2ea31e5270",
	"https://content.cfx.re/mirrors/patches_fivem/3258/update.rpf",
	1423288320,
	{
	...
	{
	"update/update2.rpf",
	"6e7c1bdd4b0b8d47ac28bef19d2644f3240ad248",
	"https://content.cfx.re/mirrors/patches_fivem/3258/update2.rpf",
	416053248,
	{
	...
	{
	"update/update.rpf",
	"fd46de4495d32f0533b8b3ae72507b829e8650f3",
	"https://content.cfx.re/mirrors/patches_fivem/3179/update.rpf",
	1416300544,
	{
	...
	{
	"update/update2.rpf",
	"cfea3456309664bf8762e3bce5957211f3ee8b39",
	"https://content.cfx.re/mirrors/patches_fivem/3179/update2.rpf",
	403941376,
	{
	...
	"update/update.rpf",
	"fd46de4495d32f0533b8b3ae72507b829e8650f3",
	"https://content.cfx.re/mirrors/patches_fivem/3095/update.rpf",
	1416300544,
	{
	...
	{
	"update/update2.rpf",
	"1c785e7b5cfe8331aad335b3f78952bc66b9fcb6",
	"https://content.cfx.re/mirrors/patches_fivem/3095/update2.rpf",
	403945472,
	{
	...
	{
	"update/update.rpf",
	"abc628b0ae04e68f88e0581f3572d26dbaed84d2",
	"https://content.cfx.re/mirrors/patches_fivem/2944/update.rpf",
	1087019008,
	{
	...
	{
	"update/update2.rpf",
	"a3181d68a532950da5c584100b35f79eaca7c884",
	"https://content.cfx.re/mirrors/patches_fivem/2944/update2.rpf",
	352088064,
	{
	...
	{
	"update/update.rpf",
	"66388a381347511b7b28aaf91741615e45008e8b",
	"https://content.cfx.re/mirrors/patches_fivem/2802/update.rpf",
	1079308288,
	{
	...
	{
	"update/update2.rpf",
	"c7de68bdc56ec4577bd4fce5d85cca9a4d529839",
	"https://content.cfx.re/mirrors/patches_fivem/2802/update2.rpf",
	344610816,
	{
	...
	{
	"update/update.rpf",
	"86d88c5ea36e67683a138c0e690c42fe288205fa",
	"https://content.cfx.re/mirrors/patches_fivem/2699/update.rpf",
	1073854464,
	{
	...
	{
	"update/update2.rpf",
	"414a04256bf0b00b78324478508a6beaea1ef5a7",
	"https://content.cfx.re/mirrors/patches_fivem/2699/update2.rpf",
	324530176,
	{
	...
	{
	"update/update.rpf",
	"80f9bd028e5bc781f641fe210a88579eff827989",
	"https://content.cfx.re/mirrors/patches_fivem/2612/update.rpf",
	1056649216,
	{
	...
	{
	"update/update2.rpf",
	"c993e2d14cce9462fa8ba056f3406d60050a1c92",
	"https://content.cfx.re/mirrors/patches_fivem/2612/update2.rpf",
	312209408,
	{
	...
	{
	"update/update.rpf",
	"2993b3c30f61cbbb8dbce859604d7fb717ff8dae",
	"https://content.cfx.re/mirrors/patches_fivem/2545/update.rpf",
	1366638592,
	{
	...
	{
	"update/update.rpf",
	"1824cdbc27c3e0eaa86920a38751322727872831",
	"https://content.cfx.re/mirrors/patches_fivem/2372/update.rpf",
	1132066816,
	{
	...
	{
	"update/update.rpf",
	"fe387dbc0f700d690b53d44ce1226c624c24b8fc",
	"https://content.cfx.re/mirrors/patches_fivem/2189/update.rpf",
	1276805120,
	{
	...
	{
	"update/update.rpf",
	"736f1cb26e59167f302c22385463d231cce302d3",
	"https://content.cfx.re/mirrors/patches_fivem/2060/update.rpf",
	1229002752,
	{
	...
	{
	"update/update.rpf",
	"fc941d698834e30e40a06a40f6a35b1b18e1c50c",
	"https://content.cfx.re/mirrors/patches_fivem/1604/update.rpf",
	966805504,
	{
	...
	{
	"appdata0_update.rpf",
	"e68cbb4882db0028ba2701c26ed69152ad992c2e",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/appdata0_update.rpf",
	3164623,
	} },
	{ "shaders_x64.rpf",
	{
	"shaders_x64.rpf",
	"f8ecee595e74c66c5bd02fd87c2947cf475a2614",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/shaders_x64.rpf",
	233921358,
	} },
	{ "update_1.rpf",
	{
	"update_1.rpf",
	"8c25d7345b7e69ebaee24ccfea97739ace59ba51",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/update_1.rpf",
	2833741450,
	} },
	{ "update_2.rpf",
	{
	"update_2.rpf",
	"5a77f9b8cb24e1c3e78ee33c7ed218a32e3d2e32",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/update_2.rpf",
	152046254,
	} },
	{ "update_3.rpf",
	{
	"update_3.rpf",
	"be15563d37c1ab0f655eeebb45f4d30527df950d",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/update_3.rpf",
	132374684,
	} },
	{ "update_4.rpf",
	{
	"update_4.rpf",
	"853a63af1698a970dfb73295faa76a31e56fe4bd",
	"https://content.cfx.re/mirrors/patches_redm/1491.50/update_4.rpf",
	2015028563,
	} } } },
#endif
};
...
{
	// verify if the game path is valid before checking content
	// this is to fix an issue where the launcher would try to verify content without a valid game path
	auto gameRoot = MakeRelativeGamePath(L"");

#if defined(LAUNCHER_PERSONALITY_MAIN)
	if (gameRoot.find(L"null") != std::string::npos || GetFileAttributes(gameRoot.c_str()) == INVALID_FILE_ATTRIBUTES)
	{
		auto result = EnsureGamePath();
